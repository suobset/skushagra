...
export default [
  ...
  {
    path: '/blog',
    component: ComponentCreator('/blog', '95c'),
    exact: true
  },
  {
    path: '/blog/archive',
  ...
  {
    path: '/blog/tags/code',
    component: ComponentCreator('/blog/tags/code', '707'),
    exact: true
  },
  {
  ...
  },
  {
    ...
    component: ComponentCreator('/blog/tags/hobbies', '81a'),
    exact: true
  },
  {
  ...
  {
    path: '/v4u',
    component: ComponentCreator('/v4u', '163'),
    exact: true
  },
  {
    path: '/docs',
