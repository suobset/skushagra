...
Here's the thing: macOS doesn't ship with a basic paint program (well, it used to until OS X came around...RIP [MacPaint](https://en.wikipedia.org/wiki/MacPaint)). Preview can annotate. Photos can adjust. But if you want to just *draw something*—a quick diagram, some pixels on a canvas, a red circle around the thing you're trying to explain to someone—your options are surprisingly grim.
