...
![Scratch Membership Page](/images/blog/Jan2026/ScratchMember.png)

## Some Background

I've written before about [how I got into this field](/2024/02/career-optimism-history.html). The short version: my first computer was a budget netbook with half a gig of DDR2 RAM and an Intel Atom processor that was slow as hell. Windows ran like garbage on it, which eventually pushed me toward Ubuntu, Bash scripting, and everything that followed.
...
The [Scratch Foundation](https://www.scratchfoundation.org) recently launched a membership program. There are two tiers:
...
The throughline from dragging blocks around on a budget netbook in 5th grade to [hiding Christmas trees in ARM64 assembly](/posts/2025-12-25-aarch64-christmas/) is more direct than it might appear. Scratch taught me that computers do what you tell them. That complex behavior emerges from simple rules composed together. That building things is fun. That you can make the cat move, and then you can make it do more, and then you can make it do anything.
...
[Become a Member →](https://www.scratchfoundation.org/membership)