...
* [Zed](https://zed.dev): Efforts to move away from VSC, this is actually pretty darn good. GPLv3, RUST, and GPU-accelerated on all platforms.
* [QT Creator](https://qt.io): Full GUI-based desktop programs written completely on C. Insanely helpful given most of my backend is on C. Also because I do a lot of low-level systems stuff, also on C. I love the Open Source version that comes with a standard of keeping your own codebase Open Source as well.
